...
var CHARACTERS = [
...

  {
    ...
    timeline: [
      ...
      { year: '1919', event: '赴法勤工俭学，与周恩来、邓小平等一同在巴黎投身旅欧中国少年共产党' },
    ...
    stories: [
      ...
      {
        title: '铁骨铮铮，血染团岛',
        content: '狱中，敌人用尽手段逼他供出党组织名单，李慰农始终只有一句话："青岛的工人全是我的同党！"他在牢房里用法语高唱《国际歌》，歌声传遍监区。被捕仅三天后，1925年7月29日深夜，反动军警将他秘密押往团岛海滩执行枪决。来自安徽的他，成为第一位牺牲在青岛的共产党员。远在上海的中共中央执委会收到噩耗，陈独秀含泪宣布休会，全体起立默哀。',
      }
    ],
...

  {
    ...
    info: {
      name: '周浩然',
      jiguan: '即墨段泊岚（今青岛市即墨区段泊岚镇）',
      minzu: '汉族',
      shengzu: '1915 — 1939',
      shenfen: '即墨县委组织部长 · 左翼作家',
      gongxian: '组建即墨抗日义勇军，参与创办进步刊物《汽笛》'
    },

    timeline: [
      { year: '1915', event: '出生于即墨段泊岚瓦戈庄' },
      { year: '1930', event: '在青岛参与创办左翼进步刊物《汽笛》，写下数十万字战斗檄文' },
      { year: '1937', event: '全面抗战爆发后毅然回乡，加入中国共产党' },
      { year: '1938', event: '带队在集旺疃三官庙伏击日军，大大提振了胶东百姓抗日信心' },
      { year: '1939', event: '遭叛徒出卖被捕，壮烈牺牲，年仅24岁。他是第一位在青岛本地出生并牺牲的共产党人' }
    ],

    stories: [
      {
        title: '以笔为刀，唤醒民众',
        content: '青年时期的周浩然是青岛知名左翼作家，参与创办进步刊物《汽笛》，以笔锋为武器，写下数十万文字痛斥日寇侵略、汉奸卖国。他的文章在青岛青年学生中秘密传阅，犹如黑夜中的汽笛长鸣，唤醒了一批又一批热血青年走上救亡道路。他留下的日记与诗文中，处处可见对民族命运的深切忧思和对光明前途的坚定信念。',
      },
      {
        title: '投笔从戎，伏击日军',
        content: '1937年全面抗战爆发后，周浩然毅然放下纸笔返回即墨故乡。他开办国术训练所作掩护，暗中联络爱国青年，拉起即墨抗日义勇军。1938年，他带队在集旺疃三官庙设伏，利用烟青公路的有利地形痛击日军运输队，击毙十余名敌人、烧毁敌军汽车，大大提振了胶东百姓抗日信心。',
      },
      {
        title: '宁死不屈，血洒故土',
...

  {
    ...
    timeline: [
      ...
      { year: '2003', event: '带领团队首次打破世界集装箱装卸纪录，"振超效率"诞生' },
      { year: '2006', event: '成功实施集装箱轮胎吊"油改电"技术改造' },
      { year: '2019', event: '团队第9次刷新世界纪录，至今无人打破' },
      { year: '2024', event: '习近平主席亲自颁授"人民工匠"国家荣誉称号' }
    ],
...

  {
    ...
    timeline: [
      ...
      { year: '2017', event: '青岛港自动化码头一期开港运营，桥吊单机效率创世界纪录' },
    ...
    stories: [
      ...
      {
        title: '肺癌术后，破釜沉舟',
        content: '2013年，刚做完肺癌手术在家休养的张连钢接到公司党委的电话。不顾家人反对和医生劝阻，他毅然扛起自动化码头筹建重任。面对国外专家"中国人想靠自己建设自动化码头可能性为零"的断言，他在动员会上对团队说："拼命都不一定能干好，不拼命肯定干不好。"25名技术骨干中23名是共产党员，党支部就建在项目现场。',
      },
      {
        title: '把不可能变成可能',
    ...
    media: [
      ...
      },
      {
        ...
        source: '央视综合频道（CCTV-1）',
        url: 'https://tv.cctv.com/2024/04/08/VIDEPz55WbRr1rMtIA5HIiRd240408.shtml'
      }
    ]
  },

  {
    ...
    timeline: [
      ...
      { year: '2025', event: '获授"全国劳动模范"称号' },
      { year: '2026', event: '获评"青岛榜样"' }
    ],
    ...
    media: [
      ...
      },
      {
        title: '《高维玉：民本打通致富之路》',
        source: '人民网山东频道',
        url: 'https://sd.people.com.cn/n2/2025/0917/c413021-41354432.html'
      }
    ]
  }
];
